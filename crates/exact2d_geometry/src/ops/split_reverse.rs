...
pub fn split_curve(curve: &Curve, t: f64) -> (Curve, Curve) {
    match curve {
        ...
        Curve::Poly(pc) => {
            // Split the polycurve at t: find which segment t falls in
...
/// Reverse the parameterisation direction of a curve.
...
mod tests {
    ...
    fn split_line_at_half() {
        ...
        // Both halves should meet at midpoint (2, 3)
